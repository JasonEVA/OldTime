...
static NSString *const  c_isVisible   = @"isVisible";

static NSString *const r_times  = @"times";
static NSString *const r_start  = @"start";
static NSString *const r_showId = @"showId";

@implementation NewCalendarEditResponse
@end


@implementation NewCalendarEditRequest
- (void)editScheduleByCalendarModel:(CalendarLaunchrModel *)model initialStartTime:(NSString *)initialStartTime WithSaveType:(NSInteger)SaveType{
    ...
    self.params[c_isVisible]   = [NSNumber numberWithInt:model.try_isVisible];
...
- (BaseResponse *)prepareResponse:(id)data {
    NewCalendarEditResponse *response = [NewCalendarEditResponse new];
