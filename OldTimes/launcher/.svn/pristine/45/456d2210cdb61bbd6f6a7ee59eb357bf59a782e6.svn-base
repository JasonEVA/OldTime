...
#define DEFAULT_ALERT_WIDTH 265
...
- (void)calculateFrame
{
    ...
    if ( ! hasContentView ) {
        ...
        if (self.messageView) {
            ...
            messageViewFrame = CGRectMake(0, titleLabelFrame.origin.y +  titleLabelFrame.size.height + self.titleBottomPadding, self.width, self.messageViewHeight);
            self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, self.frame.size.width, self.height + self.messageViewHeight);
            
        }else {
//            self.height = DEFAULT_ALERT_HEIGHT;
            messageViewFrame = CGRectZero;
        }
    ...
    if (self.messageView) {
        cancelButtonFrame = CGRectMake(0,
                                       self.height - self.buttonHeight+ self.messageViewHeight,
                                       self.width,
                                       self.buttonHeight);
