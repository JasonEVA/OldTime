...
typedef NS_ENUM(NSUInteger, ChatBaseCellInteractiveMode) {
	ChatBaseCellInteractiveModeInChattingRoom = 0,
	ChatBaseCellInteractiveModeInChattingRecords = 1
};
...
@property (nonatomic, assign)ChatBaseCellInteractiveMode interactiveMode;
