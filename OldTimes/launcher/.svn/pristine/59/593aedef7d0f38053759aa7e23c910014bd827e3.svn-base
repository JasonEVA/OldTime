...
//  Titans
//
//  Created by Remon Lv on 15/1/20.
//  Copyright (c) 2015年 Remon Lv. All rights reserved.
//  系统声效列表备注

#ifndef Titans_SystemSoundList_h
#define Titans_SystemSoundList_h

typedef enum
{
    system_soundOnly,
    system_shakeOnly,
    system_soundAndShake,
    system_silence,
} PlaySystemKind;        // 播放声音和震动

#define SOUNDID  1007  //1012 -iphone   1152 ipad  1109 ipad
...
/*********2、声音中文名参考**********
 .声音格式是MP3或m4r的需要转成caf格式（可先转成aif , aiff，然后修改后缀）
