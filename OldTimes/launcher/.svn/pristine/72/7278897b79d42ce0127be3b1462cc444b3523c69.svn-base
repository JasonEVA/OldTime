//
//  MeRevisedPassWordViewController.m
//  launcher
//
...
@interface MeRevisedPassWordViewController ()<UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate,UIAlertViewDelegate,BaseRequestDelegate>
...
@implementation MeRevisedPassWordViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0)
    {
        ...
        {
            MeNewPassWordTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MeNewPassWordTableViewCellID"];
            if (!cell)
            {
                cell = [[MeNewPassWordTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MeNewPassWordTableViewCellID"];
            }
...
//        }
    ...
    if (textField.tag == 100)
    {
        ...
        if (strtextfield.length >=8)
        {
            MorethanEight = YES;
        }
        
        MeNewPassWordTableViewCell *cell = [self.tableview cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:0]];
        ...
        if (haveLowercase && haveNumber && haveSpeacial && haveUpercase && MorethanEight)
        {
            self.NumberisOK = YES;
        }
