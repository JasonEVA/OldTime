...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc] initWithTitle:LOCAL(CANCEL) style:UIBarButtonItemStyleBordered target:self action:@selector(clickToDismiss)];
