...
@interface MWPhotoBrowser()<MWZoomingScrollViewDelegate>
...
- (UIButton *)gridButton
{
    if (!_gridButton) {
        ...
        _gridButton.frame = CGRectMake(10, IOS_SCREEN_HEIGHT - 40 - 10, 40, 40);
        [_gridButton setImage:[UIImage imageNamed:@"imgList"] forState:UIControlStateNormal];
        [_gridButton setBackgroundColor:[UIColor colorWithRed:50/255.0 green:50/255.0 blue:50/255.0 alpha:0.2]];
        _gridButton.layer.masksToBounds = YES;
        _gridButton.layer.cornerRadius = 5.0;
    }
    return _gridButton;
}
- (UIButton *)saveButton{
    if (!_saveButton) {
        ...
        _saveButton.frame = CGRectMake(IOS_SCREEN_WIDTH - 40 -10, IOS_SCREEN_HEIGHT - 40 - 10, 40, 40);
        [_saveButton setImage:[UIImage imageNamed:@"save"] forState:UIControlStateNormal];
        [_saveButton setBackgroundColor:[UIColor colorWithRed:50/255.0 green:50/255.0 blue:50/255.0 alpha:0.2]];
