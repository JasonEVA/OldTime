...
- (void)initBottomBar
{
    ...
    UIButton *sendButton = [QuickCreateManager creatButtonWithFrame:frame Title:LOCAL(SEND) TitleFont:[UIFont systemFontOfSize:BOTTOM_SEND_BTN_FONT] TitleColor:[UIColor whiteColor] BgImage:nil HighImage:nil BgColor:BOTTOM_SEND_BTN_BG_COLOR Tag:0];
