...
- (void)drawRect:(CGRect)rect
{
    ...
    sPoints[0] =CGPointMake(8, 24);//坐标1
    sPoints[1] =CGPointMake(0, 18);//坐标2
    sPoints[2] =CGPointMake(0, 30);//坐标3
    ...
    CGContextMoveToPoint(contextd, 8, 24);
    CGContextAddLineToPoint(contextd, 0, 18);
    
    CGContextMoveToPoint(contextd, 8, 24);
    CGContextAddLineToPoint(contextd, 0, 30);
