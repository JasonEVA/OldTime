...
{
    [userDefault setObject:version forKey:(isSubVer ? lDefaults_varsub : lDefaults_varmain)];
    [userDefault synchronize];
}
...
- (NSString *)companyName {
    return [userDefault objectForKey:[NSString wz_getSelector:_cmd]] ? :@"";
}
...
- (BOOL)isMTVersion {
	return [userDefault boolForKey:[NSString wz_getSelector:_cmd]];
}

- (void)verifyMTVersion {
	BOOL isMTVersion = YES;
#if defined(JAPANMODE) || defined(JAPANTESTMODE)
	isMTVersion = NO;
#endif
	[userDefault setBool:isMTVersion forKey:@"isMTVersion"];
}

- (void)setCompanyName:(NSString *)companyName {
    [userDefault setObject:companyName forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}

- (void)setCompanyCode:(NSString *)companyCode {
    [userDefault setObject:companyCode forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}

- (void)setCompanyShowID:(NSString *)companyShowID {
    [userDefault setObject:companyShowID forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}

- (void)setLoginName:(NSString *)loginName {
    [self setUserShowID:loginName];
}

- (void)setUserName:(NSString *)userName {
    [userDefault setObject:userName forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}

- (void)setAuthToken:(NSString *)authToken {
    [userDefault setObject:authToken forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}

- (void)setUserShowID:(NSString *)userShowID {
    [userDefault setObject:userShowID forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}

#pragma mark - 输入习惯
- (InputHabitMode)inputHabit {
    InputHabitMode inputHabit = (InputHabitMode)[userDefault integerForKey:[NSString wz_getSelector:_cmd]];
...
- (void)setInputHabit:(InputHabitMode)inputHabit {
    [userDefault setInteger:inputHabit forKey:[NSString wz_setSelector:_cmd]];
    [userDefault synchronize];
}
