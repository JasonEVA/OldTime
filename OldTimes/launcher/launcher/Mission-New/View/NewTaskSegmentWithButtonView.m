...
- (UIButton *)btnLeft {
    if (!_btnLeft) {
        _btnLeft = [self createButtonWithTitle:LOCAL(MISSION_HIGH) titleColor:[UIColor blackColor] selectedBackgroundColor:[UIColor themeBlue] pointColor:[UIColor mtc_colorWithHex:0xff3366]];
...
- (UIButton *)btnMiddle {
    if (!_btnMiddle) {
        _btnMiddle = [self createButtonWithTitle:LOCAL(MISSION_MEDIUM) titleColor:[UIColor blackColor] selectedBackgroundColor:[UIColor themeBlue] pointColor:[UIColor mtc_colorWithHex:0xffac4f]];
...
- (UIButton *)btnRight {
    if (!_btnRight) {
        _btnRight = [self createButtonWithTitle:LOCAL(MISSION_LOW) titleColor:[UIColor blackColor] selectedBackgroundColor:[UIColor themeBlue] pointColor:[UIColor mtc_colorWithHex:0xacacac]];
...
- (UIButton *)btnWithout {
    if (!_btnWithout) {
        ...
        [_btnWithout setTitle:LOCAL(NONE) forState:UIControlStateNormal];
        [_btnWithout setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_btnWithout setBackgroundImage:[UIImage mtc_imageColor:[UIColor whiteColor]] forState:UIControlStateNormal];
        
        [_btnWithout setTitleColor:[UIColor whiteColor] forState:UIControlStateSelected];
        [_btnWithout setBackgroundImage:[UIImage mtc_imageColor:[UIColor themeBlue]] forState:UIControlStateSelected];
