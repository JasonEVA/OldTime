...
- (void)imageView:(UIImageView *)imageView singleTapDetected:(UITouch *)touch {
    ...
    if ([self.zoomDelegate respondsToSelector:@selector(MWZoomingScrollViewDelegateCallBack_imageViewClick)]) {
        [self.zoomDelegate MWZoomingScrollViewDelegateCallBack_imageViewClick];
    }
}
