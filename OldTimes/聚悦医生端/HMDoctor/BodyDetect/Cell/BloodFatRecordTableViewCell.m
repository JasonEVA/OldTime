...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        [lbDate setFont:[UIFont systemFontOfSize:10]];
        ...
        [lbTG setFont:[UIFont systemFontOfSize:12]];
        ...
        [lbTC setFont:[UIFont systemFontOfSize:12]];
        ...
        [lbHDLC setFont:[UIFont systemFontOfSize:12]];
        ...
        [lbLDLC setFont:[UIFont systemFontOfSize:12]];
