...
@interface SelectAppointmentTimeView ()
{
...
@implementation SelectAppointmentTimeView
...
- (void)confirmDateBtnClick
{
    ...
    {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"时间有误" message:@"选择的日期不能小于当前时间。" delegate:nil cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
        [alert show];
        return;
    }
