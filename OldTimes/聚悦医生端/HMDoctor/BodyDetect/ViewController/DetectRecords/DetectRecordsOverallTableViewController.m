...
@interface DetectRecordsOverallTableViewController ()<TaskObserver>
{
...
{
    NSString* url = [NSString stringWithFormat:@"%@/bimChart.htm?vType=YS&kpiCode=%@&userId=%@", kZJKHealthDataBaseUrl ,@"YQ_TZ", userId];
    return url;
}
