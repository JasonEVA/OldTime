...
{
    NSString* url = [NSString stringWithFormat:@"%@/ztqs_flotChart.htm?vType=YS&&kpiCode=%@&userId=%@&dateType=%ld&childKpiCode=%@", kZJKHealthDataBaseUrl ,kpiCode, _userId, _timetype, childKpiCode];
    return url;
}
