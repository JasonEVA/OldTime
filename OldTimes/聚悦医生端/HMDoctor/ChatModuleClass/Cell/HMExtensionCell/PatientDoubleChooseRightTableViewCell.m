//
//  PatientDoubleChooseRightTableViewCell.m
//  HMDoctor
//
...
@interface PatientDoubleChooseRightTableViewCell ()
...
@implementation PatientDoubleChooseRightTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.textContentLb mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.top.equalTo(self.imgViewBubble).offset(20);
...
- (UILabel *)textContentLb {
    if (!_textContentLb) {
        ...
        [_textContentLb setFont:[UIFont systemFontOfSize:15]];
        [_textContentLb setNumberOfLines:0];
        [_textContentLb setText:@"fklajlkjsadfjl;ksajfljl;kfjlskadjflkjalkfj;lskdjf"];
    }
...
- (UIButton *)yesBtn {
    if (!_yesBtn) {
        ...
        [_yesBtn setUserInteractionEnabled:NO];
    }
    return _yesBtn;
}
...
- (UIButton *)noBtn {
    if (!_noBtn) {
        ...
        [_noBtn setUserInteractionEnabled:NO];
