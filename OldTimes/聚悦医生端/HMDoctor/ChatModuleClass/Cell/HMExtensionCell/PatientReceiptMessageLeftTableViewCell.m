//
//  PatientReceiptMessageLeftTableViewCell.m
//  HMDoctor
//
...
@interface PatientReceiptMessageLeftTableViewCell ()
@property (nonatomic, strong) UILabel *receiptStatusLb;
@end

@implementation PatientReceiptMessageLeftTableViewCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.receiptStatusLb mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.imgViewBubble.mas_right).offset(5);
        }];
    }
    return self;
}
