...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[[UIImage imageNamedFromMyBundle:_tzImagePickerVc.photoOriginSelImageName] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateSelected];
        _originalPhotoButton.tintColor = [UIColor mainThemeColor];
    ...
    _numberImageView = [[UIImageView alloc] initWithImage:[[UIImage imageNamedFromMyBundle:_tzImagePickerVc.photoNumberIconImageName] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
    ...
    _numberImageView.tintColor = [UIColor mainThemeColor];
