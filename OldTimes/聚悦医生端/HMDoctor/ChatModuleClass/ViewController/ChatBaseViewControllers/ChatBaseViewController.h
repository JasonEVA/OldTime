...
@property (nonatomic, assign)  IMChatType  chatType; // 聊天类型
@property (nonatomic, assign, readonly)  BOOL  hideInputView; // 是否隐藏输入栏

@property (nonatomic) BOOL isReceiptOn;      // 回执消息状态时否打开
