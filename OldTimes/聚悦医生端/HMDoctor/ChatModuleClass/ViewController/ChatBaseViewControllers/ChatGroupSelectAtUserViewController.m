...
- (void)getDataList {
    ...
    [[MessageManager share] MTRequestGroupInfoWirhGroupId:self.groupID completion:^(UserProfileModel *model) {
        ...
        _groupPeople = [NSMutableArray arrayWithCapacity:model.memberList.count];
        NSString *myselfShowId = [MessageManager getUserID];
        
        for (UserProfileModel *person in model.memberList) {
        ...
        strongSelf.adapter.adapterArray = strongSelf.groupPeople;
