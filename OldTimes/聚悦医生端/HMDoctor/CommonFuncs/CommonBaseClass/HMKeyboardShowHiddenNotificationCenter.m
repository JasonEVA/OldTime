//
//  HMKeyboardShowHiddenNotificationCenter.m
//  HMDoctor
//
...
@implementation HMKeyboardShowHiddenNotificationCenter
...
+ (HMKeyboardShowHiddenNotificationCenter *)defineCenter{
    static HMKeyboardShowHiddenNotificationCenter * center = nil;
    if (center == nil) {
        center = [[HMKeyboardShowHiddenNotificationCenter alloc] init];
        center.delegate = nil;
...
- (void)setDelegate:(id<HMKeyboardShowHiddenNotificationCenterDelegate>)delegate{
    _delegate = delegate;
