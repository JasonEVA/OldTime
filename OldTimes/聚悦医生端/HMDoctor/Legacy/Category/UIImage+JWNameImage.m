...
+ (UIImage *)JW_acquireNameImageWithNameString:(NSString *)string imageSize:(CGSize)size {
    return [UIImage JW_createNikeNameImageName:[UIImage JW_dealWithNikeName:string] imageSize:size font:[UIFont systemFontOfSize:14]];
}

+ (UIImage *)JW_acquireNameImageWithNameString:(NSString *)string imageSize:(CGSize)size font:(UIFont *)font{
    return [UIImage JW_createNikeNameImageName:[UIImage JW_dealWithNikeName:string] imageSize:size font:font];
}
...
// 根据nikeName绘制图片
+ (UIImage *)JW_createNikeNameImageName:(NSString *)name imageSize:(CGSize)size font:(UIFont *)font{
    ...
    [name drawAtPoint : CGPointMake ( (size.width  - nameSize.width) / 2 , (size.height  - nameSize.height) / 2 ) withAttributes : @{ NSFontAttributeName :font, NSForegroundColorAttributeName :[ UIColor colorWithHexString:@"ffffff" ] } ];
