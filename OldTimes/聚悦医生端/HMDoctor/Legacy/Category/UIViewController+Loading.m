...
- (void)at_postSuccess                     { [self at_postSuccess:@""];}
- (void)at_postSuccess:(NSString *)message { [self at_postSuccess:message overTime:TipNormalOverTime];}
...
- (void)at_postError:(NSString *)message                            { [self at_postError:message detailMessage:@"" duration:TipNormalOverTime];}
- (void)at_postError:(NSString *)message duration:(CGFloat)duration { [self at_postError:message detailMessage:@"" duration:duration];}
...
- (void)at_postLoading                                               { [self at_postLoading:@""];}
- (void)at_postLoading:(NSString *)message                           { [self at_postLoading:message message:@""];}
- (void)at_postLoading:(NSString *)title message:(NSString *)message { [self at_postLoading:title message:message overTime:TipLoadingOverTime];}
