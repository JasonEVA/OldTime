//
//  EvaluationRecordTableViewCell.m
//  HMClient
//
...
@interface EvaluationListRecord (EvaluationDate)

@end

@implementation EvaluationListRecord (EvaluationDate)
...
@interface EvaluationRecordTableViewCell ()
{
    UIView* topLine;
    UIView* bottomline;
    UIView* circleView;
    ...
    EvaluationRecordView* recordview;
}
@end

@implementation EvaluationRecordTableViewCell
...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        recordview = [[EvaluationRecordView alloc]init];
...
- (void)setEvaluationRecord:(EvaluationListRecord *)record
{
    ...
    [recordview setEvaluationRecord:record];
}
