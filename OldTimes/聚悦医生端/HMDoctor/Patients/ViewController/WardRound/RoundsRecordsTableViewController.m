...
- (void)loadRoundsListMonths
{
    ...
    [[TaskManager shareInstance] createTaskWithTaskName:@"RoundsMonthsListTask" taskParam:dicPost TaskObserver:self];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [HMViewControllerManager createViewControllerWithControllerName:@"RoundsRecordsDetailViewController" ControllerObject:record.itemId];
