...
//static JYBluetoothManager *bleManager = nil;

@interface JYBluetoothManager ()
...
@implementation JYBluetoothManager
...
{
    //isScanning iOS以后可用
    if (_centralManager.isScanning  && IOS_VERSION_9_OR_ABOVE){
        return;      //如果正在扫描，返回
    }
    [self setupUntil];
