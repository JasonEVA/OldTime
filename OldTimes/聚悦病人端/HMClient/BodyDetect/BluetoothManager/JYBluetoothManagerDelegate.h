...
#ifndef JYBluetoothManagerDelegate_h
#define JYBluetoothManagerDelegate_h
...
@protocol JYBluetoothManagerDelegate <NSObject>

- (void)currentCentralManagerStatus:(BLEStatus)status;
//- (void)currentBLEConnectState:(BLEConnectState)statu;
...
#endif /* JYBluetoothManagerDelegate_h */
