...
#import "BodyDetectPopupSelectView.h"
...
@interface BloodSugarConstastRecordsChartTableViewCell()
{
    ...
    BodyDetectPopupSelectView *testPeriodView;
}
@end
...
{
    testPeriodView = [[BodyDetectPopupSelectView alloc] initWithKpiCode:@"XT"];
...
//    testPeriodView = [[BloodSugarDetectTestPeriodViewController alloc] init];
//    [self addSubview:testPeriodView.view];
//    testPeriodView.isChart = YES;
//    
//    __weak typeof(self) weakSelf = self;
//    __weak typeof(lbperiod) weakLbperiod = lbperiod;
//
//    testPeriodView.testTimeBlock = ^(NSDictionary* testPeriodItem){
//        [weakLbperiod setText:[testPeriodItem valueForKey:@"name"]];
//        
//        childKpi = [testPeriodItem valueForKey:@"code"];
//        
//        [weakSelf reloadChart];
//    };
//    
//    [testPeriodView.view mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)periodControlClick
{
    testPeriodView = [[BodyDetectPopupSelectView alloc] initWithKpiCode:@"XY"];
    [self addSubview:testPeriodView];
