...
- (void) setDetectResult:(DetectResult*) result
{
    ...
    if (!kStringIsEmpty(bpResult.testTimeName)) {
        [lbDetectPeriod setAttributedText:[NSAttributedString getAttributWithUnChangePart:@"测量时段：" changePart:[NSString stringWithFormat:@"%@",bpResult.testTimeName] changeColor:[UIColor commonTextColor] changeFont:[UIFont font_28]]];
    }
}
@end
