...
//        NSArray* colors = @[[UIColor colorWithHexString:@"6f8ae3"], [UIColor commonBlueColor], [UIColor commonGreenColor], [UIColor commonOrangeColor], [UIColor commonRedColor]];
//        NSArray* standands = @[@"过低", @"偏低", @"正常", @"偏高", @"过高"];
...
//        }
        ...
        [lbValue setFont:[UIFont boldFont_36]] ;
        
        
        standardLables = [NSMutableArray array];
//        NSArray* standards = @[@"0", @"2.78", @"6.7", @"9.4", @"11.1"];
...
//        }
        ...
        resultLb = [[UILabel alloc]init];
        [self addSubview:resultLb];
        [resultLb setTextColor:[UIColor mainThemeColor]];
        [resultLb setFont:[UIFont boldFont_28]];
        [resultLb setText:@"测量结果"];
        ...
        [lbConclusion setFont:[UIFont font_28]] ;
...
- (void) subviewLayout
{
    ...
    [resultLb mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(colorview.mas_bottom).with.offset(30);
        make.centerX.equalTo(self).offset(10);
    }];
    
    [ivIcon mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(resultLb);
        make.size.mas_equalTo(CGSizeMake(20, 20));
        make.right.equalTo(resultLb.mas_left).offset(-5);
    }];
    
    [lbConclusion mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.and.right.equalTo(colorview);
        make.top.equalTo(resultLb.mas_bottom).with.offset(10);
