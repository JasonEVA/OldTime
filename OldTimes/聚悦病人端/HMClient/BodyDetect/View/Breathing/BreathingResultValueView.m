...
@interface BreathingResultValueView()
{
    UIView* colorsview;
...
@implementation BreathingResultValueView
...
- (id) init
{
    ...
    if (self)
    {
        ...
        for (NSString* name in standandNames)
        {
            ...
            [lbStandand setFont:[UIFont font_20]];
        ...
        NSArray* standandValues = @[@"0", @"12", @"20", @"100"];
...
- (void) setDetectResult:(DetectResult*) detectResult
{
    ...
    [lbValue setText:[NSString stringWithFormat:@"%ld", breathResult.breathrate]];
    
    //NSInteger index = 0;
    if (12 > breathResult.breathrate)
    {
    ...
    else if (20 >= breathResult.breathrate)
    {
