...
- (id) init
{
    ...
    if (self)
    {
        ...
        [lbUserResult setFont:[UIFont font_26]];
...
- (void) setDetectRecord:(DetectRecord*) record
{
    ...
    if ([hrRecord.sourceKpiCode isEqualToString:@"XL"]) {
...
- (id) init
{
    ...
    if (self)
    {
        ...
        [lbDivisionName setFont:[UIFont font_26]];
        ...
        [lbDivision setFont:[UIFont font_26]];
