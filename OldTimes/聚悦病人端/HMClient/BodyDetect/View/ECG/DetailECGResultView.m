...
- (id) init
{
    ...
    if (self)
    {
        ...
        [lbQRSValue setFont:[UIFont font_26]];
        ...
        [lbtestTime setFont:[UIFont font_26]];
...
- (void)subViewsLayout
{
    ...
    [lbRR mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(lbHRValue.mas_right).with.offset(15);
        make.top.equalTo(lbHR.mas_top);
    }];
    ...
    [lbQRS mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(lbRRValue.mas_right).with.offset(15);
        make.top.equalTo(lbHR.mas_top);
    }];
