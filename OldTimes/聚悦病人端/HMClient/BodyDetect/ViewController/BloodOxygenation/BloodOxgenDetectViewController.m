...
@interface BloodOxgenDetectViewController ()<BloodOxygenBLEResultDelegate>
{
...
- (void) createDeviceObject
{
    if (!bleControl)
    {
        bleControl = [[BerryMedBloodOxgenBLEDevice alloc] init];
    }
    bleControl.bloodOxygenDelegate = self;
    ...
    if ([keyPath isEqualToString:@"devicesState"])
    {
        ...
        if (value && [value isKindOfClass:[NSNumber class]])
        {
            ...
            switch (numValue.intValue)
            {
                ...
                case CentralManager_Disconnect: //设备断开
                {
//                    if (_isResult)
//                    {
//                        _isResult = NO;
