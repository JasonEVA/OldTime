...
- (void) setTemperature:(NSString*) temperature
{
    ...
    switch ([temperature bodyTemperatureLevel])
    {
        ...
        {
            //低烧
            [self.instructImageView setImage:[UIImage imageNamed:@"icon_33"]];
        }
            break;
        case BodyTemperature_Normal_Level:
        {
            //正常
            [self.instructImageView setImage:[UIImage imageNamed:@"icon_30"]];
        }
            break;
        case BodyTemperature_LowFever_Level:
        {
            //低烧
            [self.instructImageView setImage:[UIImage imageNamed:@"icon_31"]];
        }
            break;
        case BodyTemperature_FingerFever_Level:
        {
            //发烧
            [self.instructImageView setImage:[UIImage imageNamed:@"icon_32"]];
        }
            break;
        case BodyTemperature_HighFever_Level:
        {
            //高烧
            [self.instructImageView setImage:[UIImage imageNamed:@"icon_34"]];
        }
            break;
        case BodyTemperature_HotFever_Level:
        {
            //超高烧
            [self.instructImageView setImage:[UIImage imageNamed:@"icon_34_1"]];
        }
            break;
    }
}
