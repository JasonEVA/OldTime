//
//  BodyWeightDetectStartViewController.m
//  HMClient
//
...
#import "BodyWeightDetectStartViewController.h"

@interface BodyWeightDetectStartViewController ()

@end

@implementation BodyWeightDetectStartViewController

- (void)viewDidLoad {
    self.allowInputType = DetectInput_Device|DetectInput_Manual;
    [super viewDidLoad];
...
{
    return @"BodyWeightDetectViewController";
}

- (NSString*) manualInputClassName
{
    return @"BodyWeightManualInputViewController";
}
