...
{
    NSString* url = [NSString stringWithFormat:@"%@/ztqs_flotChart.htm?vType=YH&&kpiCode=%@&userId=%@&dateType=%ld&childKpiCode=%@", kZJKHealthDataBaseUrl ,kpiCode, userId, _timetype, childKpiCode];
    return url;
}
