...
- (void)viewDidLoad {
    ...
    headerview = [[UIView alloc]initWithFrame:CGRectMake(0, 5, self.view.width, 37 * kScreenScale)];
...
- (void) createRecordSegmentedView
{
    ...
    recordSegmented = [[DetectRecordSegmentedView alloc]initWithFrame:CGRectMake(12.5, 7 * kScreenScale, 178.5 * kScreenScale, 30 * kScreenScale)];
...
- (void) createTimeTypeView:(NSInteger) index
{
    ...
    switch (index)
    {
        ...
        case 2:
        {
            ...
            DetectRecordDataSelectedControl* selectedControl = [[DetectRecordDataSelectedControl alloc]initWithFrame:CGRectMake(headerview.width - 12.5 - 65  * kScreenScale, headerview.height - 25 * kScreenScale, 65 * kScreenScale, 25 * kScreenScale)];
...
- (void) createDetectRecordsViewController:(NSInteger) index
{
    ...
    switch (index)
    {
        ...
        {
            //数值记录
            vcRecords = [[DetectDataRecordsTableViewController alloc]initWithUserId:userId];
        }
            break;
        default:
            break;
...
- (void) dataReordControlClicked:(id) sender
{
    ...
    DetectDataRecordsTableViewController* tvcDataRecord = (DetectDataRecordsTableViewController*) vcRecords;
