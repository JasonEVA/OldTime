...
@interface HellofitECGViewController ()<ECGBluetoothControlResultDelegate>
{
...
- (void) createDeviceObject
{
    ...
    bleControl.ECGResultdelegate = self;
...
- (void)detectBtnStart:(UIButton *)sender
{
    ...
    //请求发送数据
    [bleControl writeDate:[SysConvertUtil dataByteHexString:@"FF0403010000"]];
...
-(void)stopSendECGData
{
    ...
    //停止发送数据
    [bleControl writeDate:[SysConvertUtil dataByteHexString:@"FF0403000000"]];
