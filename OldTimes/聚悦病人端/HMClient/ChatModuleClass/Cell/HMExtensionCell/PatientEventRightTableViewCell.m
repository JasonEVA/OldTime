...
- (void)configElements {
    ...
    [leftImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.width.mas_equalTo(LEFTIMAGEHEIGHT);
...
- (void)fillInDadaWith:(MessageBaseModel *)baseModel
{
    ...
    if ([model.type isEqualToString:@"healthTest"]|| [model.type isEqualToString:@"adjustWarning"]|| [model.type isEqualToString:@"continueTest"]|| [model.type isEqualToString:@"tellVisitDoc"]|| [model.type isEqualToString:@"testResultPage"])
    {
        //监测预警消息
