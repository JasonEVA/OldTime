...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        [dealWithBtn setBackgroundImage:[UIImage imageColor:[UIColor colorWithHexString:@"999999"] size:CGSizeMake(1, 1) cornerRadius:0] forState:UIControlStateDisabled];
        [dealWithBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [dealWithBtn.titleLabel setFont:[UIFont font_26]];
        ...
        [detailBtn.titleLabel setFont:[UIFont font_26]];
