...
#define H_CARDMINHEIGHT  90  //IM卡片最小高度
#define H_NEWSHEIGHT   (130 * kScreenScale)    // 图文消息卡片高度
...
@end
@interface MessageBaseModelRoundsFilled : MessageBaseModelContent //查房已填写
{
...
@interface MessageBaseModelRoundsAsked : MessageBaseModelContent //查房询问
{
...
@interface MessageBaseAssessmentModel : MessageBaseModelContent //评估
{
...
@interface MessageBaseModelAssessmentFilled : MessageBaseModelContent //评估已填写
{
