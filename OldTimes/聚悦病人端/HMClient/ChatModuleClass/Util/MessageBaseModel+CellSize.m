...
- (CGFloat)textHeight {
    ...
    CGFloat textHeight = [model.msg heightSystemFont:[UIFont font_30] width:[self eventCellCommonWidth]];
    return textHeight;
}
//默认卡片高度
...
- (CGFloat)eventCellCommonWidth {
    ...
    CGFloat textWidth = [modelContent.msg widthSystemFont:[UIFont font_30]];
...
- (CGFloat) textbubbleWidth
{
    ...
    CGFloat textWidth = [self._content widthSystemFont:[UIFont font_30]];
    if (textWidth > maxTextWidth)
    {
        textWidth = maxTextWidth;
    }
...
- (CGFloat) alertBubbleHeight
{
    ...
    CGFloat textHeihgt = [self._content heightSystemFont:[UIFont font_24] width:maxTextWidth];
    return textHeihgt + 2;
}
...
{
    CGFloat maxTextWidth = kScreenWidth - 210;
    CGFloat textHeihgt = [self._content heightSystemFont:[UIFont font_30] width:maxTextWidth];
...
- (CGFloat) detectResultPageHeight
{
    ...
    CGFloat textHeight = [modelContent.msg heightSystemFont:[UIFont font_30] width:[self detectResultPageTextWidth]];
...
@implementation MessageBaseModelRoundsFilled : MessageBaseModelContent

@end

@implementation MessageBaseModelRoundsAsked : MessageBaseModelContent
...
@implementation MessageBaseModelAssessmentFilled
