...
- (void)configBottomToolBar {
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[[UIImage imageNamedFromMyBundle:tzImagePickerVc.photoOriginSelImageName] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateSelected];
    ...
    _numberImageView = [[UIImageView alloc] initWithImage:[[UIImage imageNamedFromMyBundle:tzImagePickerVc.photoNumberIconImageName] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
