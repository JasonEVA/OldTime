...
//    NSString *fullPath = [baseURL stringByAppendingPathComponent:model._headPic];
//    NSURL *urlHead = [NSURL URLWithString:fullPath];
...
- (UIImageView *)countBackgroundImageView {
    if (!_countBackgroundImageView) {
        _countBackgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageColor:[UIColor clearColor] size:CGSizeZero cornerRadius:countBackGroundSize / 2]];
