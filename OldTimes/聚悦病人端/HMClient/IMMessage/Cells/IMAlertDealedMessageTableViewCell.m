//
//  IMAlertDealedMessageTableViewCell.m
//  HMClient
//
...
@interface IMAlertDealedMessageTableViewCell ()
{
...
@implementation IMAlertDealedMessageTableViewCell
...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        ivComment = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"img_im_card_warm"]];
