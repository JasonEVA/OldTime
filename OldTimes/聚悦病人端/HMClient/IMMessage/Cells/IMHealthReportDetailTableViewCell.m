//
//  IMHealthReportDetailTableViewCell.m
//  HMClient
//
...
#import "IMHealthReportDetailTableViewCell.h"

@interface IMHealthReportDetailTableViewCell ()
{
...
@implementation IMHealthReportDetailTableViewCell
...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        ivComment = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"img_im_card_report"]];
