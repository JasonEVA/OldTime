...
@property (nonatomic)  BOOL  _unreplacedResendInterMsg; // 没有替换的resend消息解析的消息标记
...
/// 实时语音model
@property (nonatomic, strong) MessageVoipModel *voipModel;
...
/** 获取转发的消息 */
- (void)getForwardMessagesCompletion:(void (^)(NSArray <MessageBaseModel *>*messages, NSString *title))completion;
