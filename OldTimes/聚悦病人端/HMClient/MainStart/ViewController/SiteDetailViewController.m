...
- (void)configElements {
    ...
    [self.myContentTextView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.line.mas_top).offset(-15);
    }];
}
...
- (UILabel *)titelLb
{
    if (!_titelLb) {
        ...
        [_titelLb setFont:[UIFont font_34]];
    }
    return _titelLb;
}
...
- (UILabel *)timeLb
{
    if (!_timeLb) {
        ...
        [_timeLb setFont:[UIFont font_26]];
    }
    return _timeLb;
}
- (UITextView *)myContentTextView
{
    if (!_myContentTextView) {
        ...
        [_myContentTextView setFont:[UIFont font_30]];
