...
//    aColor = [UIColor colorWithHex:0xe8f6f1];
...
//    UIColor *borderColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3];//阴影的颜色
    ...
    sPoints[0] =CGPointMake(0, 14);//坐标1
    sPoints[1] =CGPointMake(8, 8);//坐标2
    sPoints[2] =CGPointMake(8, 20);//坐标3
...
//        CGContextSetBlendMode(context, kCGBlendModeClear);
    ...
    CGContextMoveToPoint(contextd, 0, 14);
    CGContextAddLineToPoint(contextd, 8, 8);
    
    CGContextMoveToPoint(contextd, 0, 14);
     CGContextAddLineToPoint(contextd, 8, 20);
