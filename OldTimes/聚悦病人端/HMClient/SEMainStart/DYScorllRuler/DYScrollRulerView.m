...
-(UILabel *)unitLab{
    if (!_unitLab) {
        ...
        _unitLab.textColor = [UIColor mainThemeColor];
        [_unitLab setFont:[UIFont systemFontOfSize:24]];
    }
    return _unitLab;
}
    ...
    if (_scrollByHand) {
        if (totalValue >= _maxValue) {
            ...
            if (self.isFixedCount) {
                ...
                _valueTF.text = [NSString stringWithFormat:@"%.f",_minValue];
            }
        }else{
            if (self.isFixedCount) {
