...
- (UIButton *)dayBtn {
    if (!_dayBtn) {
        ...
        [_dayBtn setTitleColor:[UIColor mainThemeColor] forState:UIControlStateSelected];
        [_dayBtn setBackgroundImage:[UIImage at_imageWithColor:[UIColor whiteColor] size:CGSizeMake(1, 1)] forState:UIControlStateSelected];
        [_dayBtn setBackgroundImage:[UIImage at_imageWithColor:[UIColor clearColor] size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
...
- (UILabel *)monthLb {
    if (!_monthLb) {
        ...
        [_monthLb setTextColor:[UIColor colorWithHexString:@"ffffff"]];
